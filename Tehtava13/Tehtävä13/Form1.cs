...
namespace Tehtävä13
{
    public partial class Form1 : Form
    {
        ...
        private void TarkistaBT_Click(object sender, EventArgs e)
        {
            ...
            string[] pojat = File.ReadAllLines("C:/Users/Lauri.Savopirtti/source/repos/Poikiennimet.txt");
            string[] tytot = File.ReadAllLines("C:/Users/Lauri.Savopirtti/source/repos/Tyttojennimet.txt");
