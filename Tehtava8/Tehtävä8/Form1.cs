...
namespace Tehtävä8
{
    public partial class Form1 : Form
    {
        ...
        private void MuutaBT_Click(object sender, EventArgs e)
        {
            ...
            string vastaus = "";
            if(AnnetunumeroTB.Text.Length > 3)
            {
                luku1 = Convert.ToInt32(AnnetunumeroTB.Text.Substring(0, 1));
                luku2 = Convert.ToInt32(AnnetunumeroTB.Text.Substring(1, 1));
                luku3 = Convert.ToInt32(AnnetunumeroTB.Text.Substring(2, 1));
                luku4 = Convert.ToInt32(AnnetunumeroTB.Text.Substring(3, 1));
                if(luku1 % 3 == 0)
                {
                    vastaus += "MMM";
                }
            ...
            else if(AnnetunumeroTB.Text.Length >2) // satkut
            {
                luku2 = Convert.ToInt32(AnnetunumeroTB.Text.Substring(0, 1));
                luku3 = Convert.ToInt32(AnnetunumeroTB.Text.Substring(1, 1));
                luku4 = Convert.ToInt32(AnnetunumeroTB.Text.Substring(2, 1));
                vastaus += sataset(luku2, vastaus);
                vastaus += kympit(luku3, vastaus);
                vastaus += ykkoset(luku4, vastaus);
            }
            else if(AnnetunumeroTB.Text.Length > 1) // kybät 
            {
                luku3 = Convert.ToInt32(AnnetunumeroTB.Text.Substring(0, 1));
                luku4 = Convert.ToInt32(AnnetunumeroTB.Text.Substring(1, 1));
                vastaus += kympit(luku3, vastaus);
                vastaus += ykkoset(luku4, vastaus);
            }
            else
            {
                luku4 = Convert.ToInt32(AnnetunumeroTB.Text.Substring(0, 1));
                vastaus += ykkoset(luku4, vastaus);
            }
